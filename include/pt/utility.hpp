...
std::string StringToLowerTransform(const std::string& str); //only needed for testing
std::string StringToUpperTransform(const std::string& str); //only needed for testing
